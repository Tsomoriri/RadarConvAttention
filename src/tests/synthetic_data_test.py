...
data_generator = synData(
    x=100, y=100, t=20, pde="advection", mux=0.1, muy=0.15, ictype="random"
)
...
out_data_t0_transformed = pt.fit_transform(
    out_data_t0.reshape(-1, 1)
...
plt.subplot(1, 2, 2)
plt.hist(
    out_data_t0_transformed, bins=30, density=True, alpha=0.7, label="Transformed Data"
)
plt.xlabel("Value")
plt.ylabel("Density")
